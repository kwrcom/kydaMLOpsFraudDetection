            ...
            <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
                    ...
                    <div className="card" style={{ padding: '2rem' }}>
                        ...
                        {loading && !stats ? (
                            <div className="animate-pulse" style={{ height: '4rem', background: '#f1f5f9', borderRadius: '8px' }}></div>
                    ...
                    <div className="card" style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: '1.75rem', fontWeight: '700', color: '#ef4444' }}>
                                    {predictions.filter(p => p.pred_label === 1).length}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ overflowX: 'auto' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <thead style={{ background: '#f8fafc' }}>
                                <tr>
                                    <th style={{ padding: '1rem', textAlign: 'left', fontSize: '0.75rem', fontWeight: '600', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                                        Time
                                    </th>
                                    <th style={{ padding: '1rem', textAlign: 'left', fontSize: '0.75rem', fontWeight: '600', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                                        Transaction ID
                                ...
                                {predictions.map((txn, idx) => {
                                    ...
                                    return (
                                        <tr key={idx} style={{
                                            ...
                                            background: isFraud ? 'rgba(239, 68, 68, 0.03)' : 'transparent',
                                            transition: 'background 0.2s'
                                        }}>
                                            <td style={{ padding: '1rem', color: '#64748b', fontSize: '0.875rem' }}>
                                                {new Date(txn.timestamp).toLocaleTimeString()}
                                            </td>
                                            <td style={{ padding: '1rem', fontFamily: 'monospace', fontSize: '0.75rem', color: '#64748b' }}>
                                                {txn.transaction_id}
                                            </td>
                                            ...
                                            <td style={{ padding: '1rem' }}>
                                                <span className={`badge ${txn.pred_proba > 0.8 ? 'badge-danger' :
                                                        txn.pred_proba > 0.5 ? 'badge-warning' :
                                                            'badge-success'
                                                    }`}>
